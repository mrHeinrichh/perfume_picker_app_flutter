...
class _ProductEditorSheetState extends State<ProductEditorSheet> {
  ...
  void _save() {
    ...
    if (_fragranceCharacteristics.isEmpty) {
      _showSheetMessage('Choose at least one fragrance characteristic.');
      return;
    }
    if (_topNotes.isEmpty || _middleNotes.isEmpty || _baseNotes.isEmpty) {
      _showSheetMessage('Choose at least one note for top, mid, and base.');
      return;
    }
  ...
  Future<void> _pickImage() async {
    try {
      ...
      _showSheetMessage('Could not open gallery. Please try again.');
    }
  }
  ...
  void _showSheetMessage(String message) {
    ...
    final localMessenger = _messengerKey.currentState;
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: store.fragranceCharacteristicOptions.map((
                          tag,
                        ) {
                          final selected = _fragranceCharacteristics.contains(
                            tag,
                          );
